...
if __name__ == '__main__':
    model = RTDETR('/kaggle/working/ultralytics-test/ultralytics/cfg/models/rt-detr/redetr-l.yaml')
    ...
    model.train(#data='/root/.cache/kagglehub/datasets/monaerkiconbinker/tumor-yolo/versions/2/breast_tumor04/data.yaml',
                ...
                data='/kaggle/input/datasets/cocokuku/yolo-tumor/my_yolo_dataset/data.yaml',
                cache=False,
                imgsz=640,
                epochs=450,
                batch= 16,
